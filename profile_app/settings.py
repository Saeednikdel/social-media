...
SECRET_KEY = ')k5s0*nj^gj8&d3o3^kxsrf2%fqv$3$y3v%8l7nw47y99pp)m2'
...
ASGI_APPLICATION = 'profile_app.asgi.application'
CHANNEL_LAYERS = {
    "default": {
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'xaniaraso@gmail.com'
EMAIL_HOST_PASSWORD = 'rprsdfifcjjvfilv'
EMAIL_USE_TLS = True
